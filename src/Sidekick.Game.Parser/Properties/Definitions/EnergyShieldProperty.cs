...
public class EnergyShieldFilter : IntPropertyFilter
{
    ...
    public override void PrepareTradeRequest(Query query, Item item)
    {
        ...
        switch (Game)
        {
            case GameType.Poe1: query.Filters.GetOrCreateArmourFilters().Filters.EnergyShield = new StatFilterValue(this); break;
            case GameType.Poe2: query.Filters.GetOrCreateEquipmentFilters().Filters.EnergyShield = new StatFilterValue(this); break;
        }
    }
}
