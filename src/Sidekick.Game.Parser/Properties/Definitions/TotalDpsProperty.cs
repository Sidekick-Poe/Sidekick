...
public class TotalDpsFilter : DoublePropertyFilter
{
    ...
    public override void PrepareTradeRequest(Query query, Item item)
    {
        ...
        switch (Game)
        {
            case GameType.Poe1: query.Filters.GetOrCreateWeaponFilters().Filters.DamagePerSecond = new StatFilterValue(this); break;
            case GameType.Poe2: query.Filters.GetOrCreateEquipmentFilters().Filters.DamagePerSecond = new StatFilterValue(this); break;
        }
    }
}
