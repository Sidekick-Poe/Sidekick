...
{
    private Regex Pattern { get; } = currentGameLanguage.Language.DescriptionQualityCurrency.ToRegexIntProperty();
    ...
    public override void Parse(Item item)
    {
        ...
        if (GetBool(IsAugmentedPattern, item.Text)) item.Properties.AugmentedProperties.Add(nameof(ItemProperties.QualityCurrency));
    }
    ...
    public override Task<TradeFilter?> GetFilter(Item item)
    {
        ...
        var filter = new QualityCurrencyFilter
        {
            ...
            ValuePrefix = "+",
            ValueSuffix = "%",
            Augmented = item.Properties.AugmentedProperties.Contains(nameof(ItemProperties.QualityCurrency)),
