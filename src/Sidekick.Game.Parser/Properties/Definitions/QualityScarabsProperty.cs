    ...
    ICurrentGameLanguage currentGameLanguage) : PropertyDefinition
{
    ...
    {
        if (game != GameType.Poe1 || item.Properties.QualityScarabs <= 0) return Task.FromResult<TradeFilter?>(null);
        ...
        var filter = new QualityScarabsFilter
        {
            ...
            ValuePrefix = "+",
            ValueSuffix = "%",
            Augmented = item.Properties.AugmentedProperties.Contains(nameof(ItemProperties.QualityScarabs)),
