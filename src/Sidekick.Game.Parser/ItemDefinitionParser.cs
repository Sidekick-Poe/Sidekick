...
)
{
    ...
    public ItemDefinition? GetInvariant(Rarity rarity, string? type, string? name)
    {
        return GetDefinition(itemDefinitionProvider.InvariantDefinitions, rarity, null, type, name);
    }
