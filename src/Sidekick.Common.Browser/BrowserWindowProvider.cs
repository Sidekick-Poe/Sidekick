...
) : IBrowserWindowProvider
{
    ...
    public event Action<BrowserRequestOptions>? WindowOpened;

    public async Task<BrowserResult> OpenBrowserWindow(BrowserRequestOptions options, CancellationToken cancellationToken = default)
    {
