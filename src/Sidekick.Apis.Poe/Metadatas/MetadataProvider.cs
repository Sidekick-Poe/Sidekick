...
namespace Sidekick.Apis.Poe.Metadatas
{
    public class MetadataProvider(
        ...
        IGameLanguageProvider gameLanguageProvider) : IMetadataProvider
    {
        ...
        public async Task Initialize()
        {
            ...
            var result = await cacheProvider.GetOrSet("Metadata", () => poeTradeClient.Fetch<ApiCategory>(GameType.PathOfExile, gameLanguageProvider.Language, "data/items"));
