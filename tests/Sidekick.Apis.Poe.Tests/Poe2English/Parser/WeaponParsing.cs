...
");
        ...
        Assert.Equal(ItemClass.Bow, actual.ItemClass);
...
");
        ...
        Assert.Equal(ItemClass.Crossbow, actual.ItemClass);
...
");
        ...
        Assert.Equal(ItemClass.Sceptre, actual.ItemClass);
        Assert.Equal(Rarity.Magic, actual.Properties.Rarity);
...
");
        ...
        Assert.Equal(ItemClass.Spear, actual.ItemClass);
        Assert.Equal(Rarity.Magic, actual.Properties.Rarity);
...
");
        ...
        Assert.Equal(ItemClass.Warstaff, actual.ItemClass);
        Assert.Equal(Rarity.Rare, actual.Properties.Rarity);
...
");
        ...
        Assert.Equal(ItemClass.Talisman, actual.ItemClass);
        Assert.Equal(Rarity.Magic, actual.Properties.Rarity);
