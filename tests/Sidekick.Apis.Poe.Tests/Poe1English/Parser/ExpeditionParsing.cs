...
");
        ...
        actual.AssertHasStat(StatCategory.Pseudo, "Has Logbook Faction: Druids of the Broken Circle");
        actual.AssertHasStat(StatCategory.Pseudo, "Has Logbook Faction: Order of the Chalice");
    }
